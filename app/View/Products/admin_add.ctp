        ...
        <fieldset>
                ...
                <div class="tab-content">
                        <div class="tab-pane active" id="fra">
                                ...
                                echo $this->Form->input('Product.alergy_informations.fra', array('class' => 'form-control', 'type' => 'textarea', 'label' => 'Alergy Informations (ajouter code img [s_gluten, s_lactose, s_oeuf, s_soja] ex. "Ne contient pas du gluten et lactose / s_gluten s_lactose" )'));
                        ...
                        <div class="tab-pane" id="deu">
                                ...
                                echo $this->Form->input('Product.alergy_informations.deu', array('class' => 'form-control', 'type' => 'textarea', 'label' => 'Alergy Informations (ajouter code img [s_gluten, s_lactose, s_oeuf, s_soja] ex. "Ne contient pas du gluten et lactose / s_gluten s_lactose" )'));
                        ...
                        <div class="tab-pane" id="ita">
                                ...
                                echo $this->Form->input('Product.alergy_informations.ita', array('class' => 'form-control', 'type' => 'textarea', 'label' => 'Alergy Informations (ajouter code img [s_gluten, s_lactose, s_oeuf, s_soja] ex. "Ne contient pas du gluten et lactose / s_gluten s_lactose" )'));
                        ...
                        <div class="tab-pane" id="eng">
                                ...
                                echo $this->Form->input('Product.alergy_informations.eng', array('class' => 'form-control', 'type' => 'textarea', 'label' => 'Alergy Informations (ajouter code img [s_gluten, s_lactose, s_oeuf, s_soja] ex. "Ne contient pas du gluten et lactose / s_gluten s_lactose" )'));
