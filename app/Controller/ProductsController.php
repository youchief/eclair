...
class ProductsController extends AppController {
        ...
        public function view($id = null) {
                ...
                $this->Product->Recipe->Behaviors->attach('Containable');

                $product = $this->Product->Recipe->find('all', array(
                    'contain' => array(
                        'Product' => array(
                ...
                /*
                  ...
                  $recipes = $this->Product->Recipe->findByProductId($product['Product']['id']);
